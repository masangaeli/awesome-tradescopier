<x-app-layout>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-4">
                                <i class="fa-solid fa-pencil" onclick="updateMaster('{{ $masterAccount->id }}', '{{ $masterAccount->masterTitle }}', '{{ $masterAccount->masterInfo }}', '{{ $masterAccount->masterSoftware }}')"></i>
                            </div>
    ...
    <!-- Edit Master Account Modal -->
    <div class="modal fade" id="editMasterAccountModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Master Account</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="{{ route('postUpdateMaster') }}" method="POST">
                <table>
                    <tr>
                        <td>Title</td>
                    ...
                    <tr>
                        <td>Info</td>
                        <td>
                            <input type="hidden" name="masterAccountId" id="masterAccountId" />
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="mtVersion" id="mtVersion">
                    ...
                    <tr>
                        ...
                        <td><input type="submit" value="Update Master" class="btn btn-primary form-control"></td>
                    </tr>                    
                </table>
            </form>
        </div>
...
function updateMaster(masterAccountId, accountTitle, accountInfo, masterVersion)
{
    $("#editMasterAccountModal").modal('show')

    $("#masterAccountId").val(masterAccountId)
    $("#title").val(accountTitle)
    $("#info").val(accountInfo)
    $("#mtVersion").val(masterVersion)
