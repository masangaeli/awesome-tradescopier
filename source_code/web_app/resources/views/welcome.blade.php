                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <a href="{{ route('index') }}">
                            <img src="{{ asset('pics/logo.png') }}" style="width: 150px; height: 150px;"/>
                            </a>
                        </div>
                        @if (Route::has('login'))
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <strong>
                                <h2>Trades Copier</h2> <br/><hr/><br/>
                                <p>Copy Trades from MT4/MT5 Master Accounts to Other MT4/MT5 Client Accounts</p>
                                </strong>
                            ...
                            <div class="col-3">
                            <img src="https://www.infinox-zh.com/img/trading-platforms/mt4/header.png" alt="" style="width: 100px; height: 100px;">
                            </div>

                            <div class="col-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/27/MetaTrader_5.png" alt="" style="width: 100px; height: 100px;">
                            </div>
